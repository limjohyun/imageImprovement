...
텍스트(`app.processors.text.process_image`), 도형(`app.processors.diagram.process_image`),
악보(`app.processors.score.process_image`) 처리기가 모두 등록되어 있다(Phase3-4).
...
from app.processors import score as score_processor
...
_PROCESSOR_REGISTRY: dict[DocumentType, ProcessorFn] = {
    ...
    DocumentType.SCORE: score_processor.process_image,
}
